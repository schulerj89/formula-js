...
- When a domain decision is uncertain, create or use the relevant expert/subagent before implementation and record the accepted decision in `docs/decisions/`.
